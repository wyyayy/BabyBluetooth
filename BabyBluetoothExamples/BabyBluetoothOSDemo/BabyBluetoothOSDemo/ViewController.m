...
- (void)babyDelegate
{
    ...
    [baby setBlockOnReadValueForCharacteristic:^(CBPeripheral *peripheral
    ...
    [baby setBlockOnDiscoverDescriptorsForCharacteristic:^(CBPeripheral* peripheral
    ...
    //设置读取Descriptor的委托
    [baby setBlockOnReadValueForDescriptors:^(CBPeripheral *peripheral
